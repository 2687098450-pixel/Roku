...
import { getCharacterStats } from "./stats.js?v=75";
import { getSkillLevel, MAX_SKILL_LEVEL } from "./progression.js?v=75";
import { heroHasUnique } from "./omni/equipment.js?v=75";
