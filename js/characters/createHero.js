...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=164";
import { calcStats } from "./omni/attributes.js?v=164";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=164";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import {
  ...
  DEFAULT_HIT_RATE,
  DEFAULT_DODGE_RATE,
} from "./progression.js?v=164";
import { heroMaxMp } from "./skillMp.js?v=164";
import { normalizeSpdScale } from "./seals.js?v=164";
