...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=135";
import { calcStats } from "./omni/attributes.js?v=135";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=135";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import { heroMaxMp } from "./skillMp.js?v=135";
