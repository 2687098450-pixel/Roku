...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=111";
import { calcStats } from "./omni/attributes.js?v=111";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=111";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import {
  ...
  DEFAULT_HIT_RATE,
  DEFAULT_DODGE_RATE,
} from "./progression.js?v=111";
import { heroMaxMp } from "./skillMp.js?v=111";
