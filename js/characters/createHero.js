...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=139";
import { calcStats } from "./omni/attributes.js?v=139";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=139";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import {
  ...
  DEFAULT_HIT_RATE,
  DEFAULT_DODGE_RATE,
} from "./progression.js?v=139";
import { heroMaxMp } from "./skillMp.js?v=139";
