...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=73";
import { calcStats } from "./omni/attributes.js?v=73";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=73";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
