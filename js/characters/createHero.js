...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=77";
import { calcStats } from "./omni/attributes.js?v=77";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=77";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
