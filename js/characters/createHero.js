...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=180";
import { calcStats } from "./omni/attributes.js?v=180";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=180";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import {
  ...
  DEFAULT_HIT_RATE,
  DEFAULT_DODGE_RATE,
} from "./progression.js?v=180";
import { normalizeSpdScale } from "./seals.js?v=180";
import { readPrimary } from "./primary.js?v=180";
