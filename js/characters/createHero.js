...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=145";
import { calcStats } from "./omni/attributes.js?v=145";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=145";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
...
import {
  ...
  DEFAULT_HIT_RATE,
  DEFAULT_DODGE_RATE,
} from "./progression.js?v=145";
import { heroMaxMp } from "./skillMp.js?v=145";
import { normalizeSpdScale } from "./seals.js?v=145";
