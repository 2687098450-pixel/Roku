...
import { getCharacterStats, getAutoRotation } from "./stats.js?v=72";
import { calcStats } from "./omni/attributes.js?v=72";
import { createDefaultEquip, sumEquipBonus } from "./omni/equipment.js?v=72";
import {
  createHeroSkills,
  refreshSkillTexts,
  attrPassiveSkillId,
