...
import { skillPowerText } from "../core/utils.js?v=81";
import { OX, OY, canWalk } from "../map/island15.js?v=81";
import { createMonster } from "./roster.js?v=81";
import { MONSTER_SKILLS, TYPE_SKILL_IDS } from "./skills.js?v=81";
