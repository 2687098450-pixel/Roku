...
import { getMonsterStats, DEFAULT_MONSTER_SPEED, MONSTER_ATK_MULT } from "./stats.js?v=139";
import {
  MONSTER_SKILLS,
  bossSkillIdsForFloor,
  monsterSkillBrief,
  monsterSkillRangeLabel,
} from "./skills.js?v=139";
import { bossKindForFloor, bossMilestoneMult } from "./bossKinds.js?v=139";
import { floorHasUniqueBossLoot } from "../loot/drops.js?v=139";
...
export function createBoss({
  ...
  return {
    ...
    floor,
    combatFloor: cf,
    hasUniqueLoot: floorHasUniqueBossLoot(floor),
    row: "back",
    col: 1,
    skillIds,
