...
import { EXIT, FLOOR, WALL, createDungeonShell, canWalk } from "./island15.js?v=170";
import { getFloorDef, MAX_MOB_COUNT } from "./floors.js?v=170";
import { buildFloorMask } from "./shapes.js?v=170";
...
import { pickTrashType } from "../monsters/roster.js?v=170";
