...
import { EXIT, FLOOR, WALL, createDungeonShell, canWalk } from "./island15.js?v=160";
import { getFloorDef, MAX_MOB_COUNT } from "./floors.js?v=160";
import { buildFloorMask } from "./shapes.js?v=160";
import { createPatrolMonster } from "../monsters/slime.js?v=160";
import { createBoss, createFoolHiddenBoss } from "../monsters/boss.js?v=160";
import { pickTrashType } from "../monsters/roster.js?v=160";
