...
import { EXIT, FLOOR, createDungeonShell, canWalk } from "./island15.js?v=81";
import { getFloorDef, MAX_MOB_COUNT } from "./floors.js?v=81";
import { buildFloorMask } from "./shapes.js?v=81";
import { createPatrolMonster } from "../monsters/slime.js?v=81";
import { createBoss } from "../monsters/boss.js?v=81";
import { pickTrashType } from "../monsters/roster.js?v=81";
