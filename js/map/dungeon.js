...
import { EXIT, FLOOR, createDungeonShell, canWalk } from "./island15.js?v=62";
import { getFloorDef } from "./floors.js?v=62";
import { buildFloorMask } from "./shapes.js?v=62";
import { createPatrolMonster } from "../monsters/slime.js?v=62";
import { createBoss } from "../monsters/boss.js?v=62";
import { pickTrashType } from "../monsters/roster.js?v=62";
